...
class Base:
    ...
    The Private Class Attributes:
        __nb_object (int): Number of the instantiated Bases.
    """
    ...
    def from_json_string(json_string):
        ...
        Returns:
            ...
            Otherwise - the Python list represented by the json_string.
        """
    ...
    def save_to_file(cls, list_objs):
        """Writes  JSON serialization of a list of the objects to a file.
    ...
    def load_from_file(cls):
        """Return list of classes instantiated from the file of JSON strings.
