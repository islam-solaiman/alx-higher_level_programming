...
Python networking project, used `curl` in Bash scripts to send various types
of HTTP headers. In the process, learned about how URL's work, domain names,
